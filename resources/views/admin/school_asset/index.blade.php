...
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">School Assets</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">School Assets</h3>
                                <a href="{{ route('school-asset.create') }}" class="btn btn-primary float-right">Create Asset</a>
                            </div>
    ...
    <input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('school-asset.ajaxTable') }}" />
