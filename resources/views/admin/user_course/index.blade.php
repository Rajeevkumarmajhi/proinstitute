...
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Students Course</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('user-course.create') }}" class="btn btn-primary float-right">Create Student Course</a>
                            </div>
    ...
    <input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('user-course.ajaxTable') }}" />
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on('click', '.rowDelete', function() {
                let id = $(this).data('id');
                var url = "{{ route('user-course.delete') }}";
                swal({
                        title: "Are you sure?",
