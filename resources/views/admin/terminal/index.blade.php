...
@section('content')
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('terminal.create') }}" class="btn btn-primary float-right">Create Terminal</a>
                            </div>
    ...
    <input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('terminal.ajaxTable') }}" />
