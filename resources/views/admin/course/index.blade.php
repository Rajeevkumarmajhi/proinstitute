...
@section('content')
    ...
    <input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('course.ajaxTable') }}" />
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            initializeDTR(table_name, columns, data_url, start = 0, length = 10, data, 'Course Report');
