...
@section('content')
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('result.create') }}" class="btn btn-primary float-right">Create Result</a>
                            </div>
    ...
    <input type="hidden" id="ajaxroute" name="ajaxroute" value="{{ route('result.ajaxTable') }}" />
